...
figure_dir = Path(FIGURE_PATH) / "hct116_memory_bench_only_pca"
figure_dir.mkdir(exist_ok=True, parents=True)

output_dir = Path(OUTPUT_PATH) / "hct116_memory_bench_only_pca"
...
def setup_logger(log_path, level=logging.INFO):
    logger = logging.getLogger("hct116_memory_bench")
...
logger = setup_logger(output_dir / "hct116_memory_bench.log")

logger.info("Starting HCT116 memory benchmark")
...
results_path = output_dir / "hct116_memory_results.csv"
