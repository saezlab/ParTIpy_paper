...
figure_dir = Path(FIGURE_PATH) / "hek293t_memory_bench_only_pca"
figure_dir.mkdir(exist_ok=True, parents=True)

output_dir = Path(OUTPUT_PATH) / "hek293t_memory_bench_only_pca"
...
def setup_logger(log_path, level=logging.INFO):
    logger = logging.getLogger("hek293t_memory_bench")
...
logger = setup_logger(output_dir / "hek293t_memory_bench.log")

logger.info("Starting HEK293T memory benchmark")
...
seed_list = SEED_DICT["s"]
n_cells_list = [1_000, 2_000, 10_000, 20_000, 100_000, 200_000, 1_000_000, 2_000_000]
...
results_path = output_dir / "hek293t_memory_results.csv"
