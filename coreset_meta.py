...
p.save(figure_dir / "time_saving_vs_number_of_cells.png", dpi=300, verbose=False)
...
p.save(figure_dir / "minimal_coreset_fraction_vs_number_of_cells.png", dpi=300, verbose=False)
